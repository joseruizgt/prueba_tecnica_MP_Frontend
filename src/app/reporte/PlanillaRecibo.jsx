...
import { InputDate, ModalComponent } from "../../@components";
import { useReporte } from "./hooks/useReporte";


export const PlanillaRecibo = () => {
  ...
  const { generarReportePlanillaRecibosH } = useReporte();
  ...
  const generarReporte = () => {
    setOpen(false);
    generarReportePlanillaRecibosH(dataFormulario);
  }
            ...
            <div className="ml-5 mb-5 flex justify-between">
              <div>
                <h2 className='font-extrabold text-2xl text-blue-900'>
                  {
                    GESTION_REPORTES.reportePlanillaRecibos
                  }
                </h2>
