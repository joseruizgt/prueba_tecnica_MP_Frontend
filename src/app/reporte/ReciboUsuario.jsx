...
export const ReciboUsuario = () => {
  ...
  const { generarReporteRecibosUsuarioH } = useReporte();
  const { id } = useParams();
  ...
  const generarReporte = () => {
    setOpen(false);
    generarReporteRecibosUsuarioH(dataFormulario);
  }
            ...
            <div className="ml-5 mb-5 flex justify-between">
              <div>
                <h2 className='font-extrabold text-2xl text-blue-900'>
                  {
                    GESTION_REPORTES.reporteRecibosUsuario
                  }
                </h2>
